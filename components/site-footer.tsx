...
export function SiteFooter() {
  return (
    <footer id="contact" className="bg-pironi-bordeaux text-white pt-20 pb-10">
      <div className="container max-w-5xl mx-auto px-4 md:px-6">
        <div className="grid md:grid-cols-3 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-6">
            ...
            <Image src="/pironi/Plaque_NoirRouge_CMJN.png" alt="Logo" width={200} height={200} className="w-full rounded-2xl " />
          </div>
        ...
        <div className="border-t border-white/20 pt-10 flex flex-col md:flex-row items-center justify-between gap-6 text-sm text-white/60">
          <p>&copy; {new Date().getFullYear()} Pironi. Tous droits réservés.</p>
          <p className="italic font-pironi-serif text-lg max-sm:text-center text-white/80">
